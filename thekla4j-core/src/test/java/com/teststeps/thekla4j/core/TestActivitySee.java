...
public class TestActivitySee {
  ...
  public void simplePassingSeeActionWithReason() {
    ...
    assertThat("first element of See has a description", log.activityNodes.get(0).activityNodes.get(1).description, equalTo("verify all assertion on See activity"));
  ...
  public void simplePassingSeeActionWithOutReason() {
    ...
    assertThat("first element of See has a description", log.activityNodes.get(0).activityNodes.get(0).description, equalTo("perform a task that returns a static string after 0 attempts"));
    ...
    assertThat("second element of See has a description", log.activityNodes.get(0).activityNodes.get(1).description, equalTo("verify all assertion on See activity"));
  ...
  public void oneCheckWithFailingValidation() {
    ...
    assertThat("first element of See is a Validation activity", log.activityNodes.get(0).activityNodes.get(1).name, equalTo("ValidateResult"));
    assertThat("first element of See has a description", log.activityNodes.get(0).activityNodes.get(1).description, equalTo("verify all assertion on See activity"));
    assertThat("first element of See has out message", log.activityNodes.get(0).activityNodes.get(1).output, equalTo("com.teststeps.thekla4j.commons.error.ActivityError: \nexpect predicate 'predicate one' to pass on \nTestData\n"));
  ...
  public void multipleChecksWithFirstFailingValidation() {
    ...
    assertThat("first element of See is a Validation activity", log.activityNodes.get(0).activityNodes.get(1).name, equalTo("ValidateResult"));
    assertThat("first element of See has correct description", log.activityNodes.get(0).activityNodes.get(1).description, equalTo("verify all assertion on See activity"));
  ...
  public void passingAfterFiveTrys() {
    ...
    assertThat("first element of See has a valid description", log.activityNodes.get(0).activityNodes.get(5).description, equalTo("verify all assertion on See activity"));
  ...
  public void testListAssertion() {
    ...
    assertThat("Log should contain 1 entry", log.activityNodes.size(), equalTo(1));
    assertThat("first element is a See activity", log.activityNodes.get(0).name, equalTo("See"));
    assertThat("firstElement has description ", log.activityNodes.get(0).description, equalTo("ask if result of last activity is matching the validations (retry for PT0S time(s))"));
  ...
  public void testPassedMatchersWithGroup() {
    ...
    assertThat("sub entry 5 should be a ValidateResult action", log.activityNodes.get(0).activityNodes.get(0).activityNodes.get(6).name, equalTo("ValidateResult"));
    assertThat("sub entry 5 is a passed activity", log.activityNodes.get(0).activityNodes.get(0).activityNodes.get(6).status, equalTo(ActivityStatus.passed));
  }
