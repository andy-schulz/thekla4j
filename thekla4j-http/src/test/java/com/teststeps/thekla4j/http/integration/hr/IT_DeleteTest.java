...
import com.teststeps.thekla4j.http.spp.activities.Delete;
import java.util.function.Function;
import org.junit.jupiter.api.BeforeAll;
import org.junit.jupiter.api.Test;

public class IT_DeleteTest {
  ...
  @Test
  public void deleteRequestWithoutBody() throws ActivityError {
    Actor tester = Actor.named("Tester")
        .whoCan(UseTheRestApi.with(JavaNetHttpClient.using(HttpOptions.empty())));
    ...
    assertThat("status code is 200", result.statusCode(), equalTo(200));
    assertThat("response body contains data", result.response(), containsString("\"data\": \"\""));
  }
}
