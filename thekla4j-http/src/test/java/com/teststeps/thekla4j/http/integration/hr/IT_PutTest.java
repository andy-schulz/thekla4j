...
public class IT_PutTest {
  ...
  @Test
  public void putRequestChangedBody() throws ActivityError {
    ...
    HttpResult result = tester
        .attemptsTo(
          Put.to(request).body("changed body"))
        .getOrElseThrow(Function.identity());

    assertThat("status code is 200", result.statusCode(), equalTo(200));
    assertThat("response body contains data", result.response(), containsString("changed body"));
