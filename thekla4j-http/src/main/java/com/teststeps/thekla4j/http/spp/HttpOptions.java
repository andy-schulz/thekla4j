...
public class HttpOptions {
    ...
    /**
     * Default timeout to receive a response from server.
     * Overwrite this value for long running requests where needed, calling responseTimeout() setter
     */
    ...
    public HttpOptions header(@NonNull RestHeaderType headerType, @NonNull String headerValue) {
        return header(RestHeaderType.mapToString(headerType), headerValue);
    }
    ...
    public <T> HttpOptions header(@NonNull RestHeaderType headerType, @NonNull Option<T> headerValue) {
        return header(RestHeaderType.mapToString(headerType), headerValue);
    }
    ...
    private HttpOptions getNewRestOptions() {
        return new HttpOptions(this.headers, this.queryParameters, this.pathParameters, this.formParameters, this.baseUrl, this.port, this.body, this.disableSSLCertificateValidation, this.responseTimeout);
    }
    ...
    private HttpOptions(Map<String, String> headers,
