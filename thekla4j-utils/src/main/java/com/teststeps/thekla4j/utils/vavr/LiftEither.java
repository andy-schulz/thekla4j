...
public class LiftEither {
  ...
  public static <E extends Throwable, U1, U2> Function2<
      Either<E, U1>,
      Either<E, U2>,
      Either<E, Tuple2<U1, U2>>> toTuple2() {
   ...
   * @return
   */
  public static <E extends Throwable, T, U, V, W> Function1<
      Tuple4<Either<E, T>, Either<E, U>, Either<E, V>, Either<E, W>>,
      Either<E, Tuple4<T, U, V, W>>> fromTuple4() {
    return tuple4 -> tuple4.apply(toTuple4());
  }

  public static <E extends Throwable, U1, U2, U3, U4> Function4<
      Either<E, U1>,
      Either<E, U2>,
      Either<E, U3>,
      Either<E, U4>,
      Either<E, Tuple4<U1, U2, U3, U4>>> toTuple4() {
   ...
   * @return
   */
  public static <E extends Throwable, T, U, V, W, X> Function1<
      Tuple5<Either<E, T>, Either<E, U>, Either<E, V>, Either<E, W>, Either<E, X>>,
      Either<E, Tuple5<T, U, V, W, X>>> fromTuple5() {
    return tuple5 -> tuple5.apply(toTuple5());
  }

  public static <E extends Throwable, U1, U2, U3, U4, U5> Function5<
      Either<E, U1>,
      Either<E, U2>,
      Either<E, U3>,
      Either<E, U4>,
      Either<E, U5>,
      Either<E, Tuple5<U1, U2, U3, U4, U5>>> toTuple5() {
